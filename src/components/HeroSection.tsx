...
function HeroSection() {
  return (
    <div
      className="h-auo md:h-[40rem] w-full rounded-full flex flex-col items-center justify-center relative
